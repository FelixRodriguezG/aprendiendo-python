...
num_str = str(7)
print(num_str + " es mi número favorito")
...
# el resultado en una variable booleana resultado. Imprimeel valor de resultado.
a = 12
b = 8
resultado = a > b
print(resultado)
...
cadena1 = "apple"
cadena2 = "banana"
print(cadena1 < cadena2)  # True, porque "apple" viene antes que "banana" en orden alfabético
print(cadena1 > cadena2)  # False, porque "apple" no viene después que "banana" en orden alfabético 
...
resultado_and = (10 > 5) and (10 < 20)
print(resultado_and)
# 8. Usa el operador or para verificar si el número 7 es menor que 3 o mayor que 5. Imprime el resultado.
resultado_or = (7 < 3) or (7 > 5)
print(resultado_or) 
# 9. Aplica el operador not para invertir el resultado de la comparación 15 > 20. ¿Cuál es el resultado?
resultado_not = not (15 > 20)
print(resultado_not)  # True, porque 15 no es mayor que 20
# 10. Combina operadores aritméticos y lógicos: Verifica si el número resultante de la expresión (5 * 3) + 2 es mayor que 10 y menor que 20. Imprime el resul
resultado_combinado = ((5 * 3) + 2 > 10) and ((5 * 3) + 2 < 20)
print(resultado_combinado)  # True, porque 17 es mayor que 10 y menor que 20.